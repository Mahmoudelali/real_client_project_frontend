  ...
  return !orders || loading ? (
    ...
    <div className="orders-container">
      ...
      <table>
        <thead>
          <tr>
            <td colSpan={6} style={{ padding: 0, marginBottom: "10px" }}>
              ...
              .filter((order) => {
                return search === ""
                  ...
                  : order._id.toLowerCase().includes(search) ||
                      ...
                      order.user_id._id.toLowerCase().includes(search) ||
                      order.user_id.username.toLowerCase().includes(search);
              })
              .slice((currentPage - 1) * pageSize, currentPage * pageSize)
              .map(({ address, message, total, user_id, _id, state }) => (
                <OrderRow
                  state={state}
                  key={_id}
                  address={address}
